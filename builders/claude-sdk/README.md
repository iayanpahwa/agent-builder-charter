...
Planned builder that turns a CHARTER charter into an enforced agent on **the Claude Agent SDK (claude-agent-sdk)**. Not
...
- translate a charter into the Claude Agent SDK (claude-agent-sdk)'s config (model, tools, turn cap, MCP, system prompt, …),
