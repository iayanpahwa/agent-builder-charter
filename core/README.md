...
| `validate.py` | Validate one charter and exit non-zero if it's invalid. Used by CI and by the `create-headless-agent` generator, which loops until a generated charter passes. | `python3 validate.py <charter.yaml>` |
